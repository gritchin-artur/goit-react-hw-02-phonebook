...
// listener submit
  handleSubmit = event => {
    ...
    this.props.submitChange(contactForAdd);
  ...
  render() {
    ...
    return (
      <div >
        <form type="submit" onSubmit={this.handleSubmit} className='formContainer'>
          ...
          <button type="submit" className='buttonAddStyle'>Add contact</button>
